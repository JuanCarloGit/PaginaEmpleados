                    ...
                    <div class="card-body p-0">
                        ...
                        <div class="row">
                            <div class="col-lg-6 d-none d-lg-block ">
                                <object data="/img/category_create.svg" type="image/svg+xml"width="400px" height="400px"
                                    style="margin-top: 30px; margin-left: 70px"></object>
                            </div>
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <div class="form-group">
                                        {{ Form::text('cedula', null, ['class' => 'form-control', 'placeholder' => 'Cedula', 'readonly']) }}
                                    </div>
                                    ...
                                    <div class="form-group">
                                        {{ Form::text('ciudad', null, ['class' => 'form-control', 'placeholder' => 'Ciudad', 'readonly']) }}
                                    </div>
                                    <div class="form-group">
